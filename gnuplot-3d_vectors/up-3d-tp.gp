...
set yrange [:1.001*pi]
set ylabel 'polar' 
set ylabel  offset character -10, 0, 0 font "" textcolor lt -1 norotate
set ytics pi/2
set ytics ('0' 0.0, 'π/2' pi/2, 'π' pi)

set zlabel 'azimuth' 
set zrange [-1.001*pi:1.001*pi]
set zlabel  offset character -4, 0, 0 font "" textcolor lt -1 norotate
set ztics pi/2
set ztics ('-π' -pi, '-π/2' -pi/2, 0, 'π/2' pi/2, 'π' pi)
