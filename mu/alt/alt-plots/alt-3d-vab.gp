...
set zlabel '{\large $|\mathcal{V}^{\mathrm{x}}|(\omega)$ [Km/s]}' rotate parallel offset 1.0, 0.0, 0.0 
...
set ylabel '{\large Polarization angle $\alpha$ [deg.]}'  rotate parallel offset 1.3,-1.0, 0.0
set xlabel '{\large Photon Energy [eV]}'                  rotate parallel offset 0.0,-1.5, 0.0
set zlabel '{\large $|\mathcal{V}^{\mathrm{y}}|(\omega)$ [Km/s]}' rotate parallel offset 1.0, 0.0, 0.0 
