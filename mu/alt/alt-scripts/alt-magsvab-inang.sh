...
grep "$en2" "$outputkk" > magsv.kk_ax_14452_65-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_ax_14452_65-"$fs1"
...
grep "$en2" "$outputkk" > magsv.kk_ay_14452_65-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_ay_14452_65-"$fs1"
...
grep "$en2" "$outputkk" > magsv.kk_az_14452_65-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_az_14452_65-"$fs1"
