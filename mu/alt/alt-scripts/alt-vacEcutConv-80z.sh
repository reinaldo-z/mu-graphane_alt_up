...
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 12 -P 4601 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 2
grep -n cut setUpAbinit*
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 12 -P 5611 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 2
grep -n cut setUpAbinit*
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 12 -P 6698 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 2
grep -n cut setUpAbinit*
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 12 -P 7858 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
