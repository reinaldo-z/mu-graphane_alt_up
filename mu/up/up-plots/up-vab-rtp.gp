...
p   '../up-res-0-4-2001pts/v.sm_0.03_xx_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:($2*f) w l lw 2.5 dt 2 t '$ \mathcal{V}^{\mathrm{xx}} $' ,\
...
set origin 0.0 , 1.5
set size   1.0 , 0.5
p   '../up-res-0-4-2001pts/vab-rtp.sm_0.03_x_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:($6*d) w l lw 2.5  dt 2 t '$\theta$' ,\
    '../up-res-0-4-2001pts/vab-rtp.sm_0.03_x_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:($7*d) w l lw 2.5  dt 3 t '$\varphi$' 
