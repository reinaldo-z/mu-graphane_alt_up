...
set yrange [-40:40]
set ytics 10
set ylabel '$\mathcal{V}^{\mathrm{ax}}$ @ 40$^{\circ}$ [Km/s]'
...
set yrange [-25:26]
set ytics 5
set ylabel '$\mathcal{V}^{\mathrm{ay}}$ @ 40$^{\circ}$ [Km/s]'
...
set yrange [-20:100]
set ytics 20
set ylabel '$\mathcal{V}^{\mathrm{az}}$ @ 40$^{\circ}$ [Km/s]'
...
p   '< paste  ../up-res-0-4-2001pts/v.sm_0.03_xx_12802_40-spin_scissor_0_Nc_32_ang_040 ../up-res-0-4-2001pts/v.sm_0.03_yx_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:(f*sqrt($2**2 + $4**2)) w l lw 1.5 dt 1 t '$|\mathcal{V}_{\sigma^{\mathrm{x}}}|$' ,\
    '< paste  ../up-res-0-4-2001pts/v.sm_0.03_xy_12802_40-spin_scissor_0_Nc_32_ang_040 ../up-res-0-4-2001pts/v.sm_0.03_yy_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:(f*sqrt($2**2 + $4**2)) w l lw 2.5 dt 2 t '$|\mathcal{V}_{\sigma^{\mathrm{y}}}|$' ,\
    '< paste  ../up-res-0-4-2001pts/v.sm_0.03_xz_12802_40-spin_scissor_0_Nc_32_ang_040 ../up-res-0-4-2001pts/v.sm_0.03_yz_12802_40-spin_scissor_0_Nc_32_ang_040' u 1:(f*sqrt($2**2 + $4**2)) w l lw 2.5 dt 3 t '$|\mathcal{V}_{\sigma^{\mathrm{z}}}|$' ,\
