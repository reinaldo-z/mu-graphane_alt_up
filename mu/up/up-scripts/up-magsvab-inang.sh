...
grep "$en2" "$outputkk" > magsv.kk_ax_12802_40-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_ax_12802_40-"$fs1"
...
grep "$en2" "$outputkk" > magsv.kk_ay_12802_40-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_ay_12802_40-"$fs1"
...
grep "$en2" "$outputkk" > magsv.kk_az_12802_40-"$fs1"
grep "$en2" "$outputsm" > magsv.sm_0.03_az_12802_40-"$fs1"
