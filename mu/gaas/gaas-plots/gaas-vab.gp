...
set ylabel "$\\cal{V}^{\\mathrm{zz}}$ [$\\times 10^{3}$ m/s]" 
set output "gaas-vxxyyzz.mp"
p   '../gaas-res-0-4-2001pts/v.sm_0.03_xx_5216_15-spin_scissor_0_Nc_24_ang_45' u 1:($2*pf*sl) w l lw 2 t 'xx @ 45$^{\circ}$' ,\
    '../gaas-res-0-4-2001pts/v.sm_0.03_yy_5216_15-spin_scissor_0_Nc_24_ang_45' u 1:($2*pf*sl) w l lw 2 t 'yy @ 45$^{\circ}$' ,\
    '../gaas-res-0-4-2001pts/v.sm_0.03_zz_5216_15-spin_scissor_0_Nc_24_ang_45' u 1:($2*pf*sl) w l lw 2 t 'zz @ 45$^{\circ}$'
