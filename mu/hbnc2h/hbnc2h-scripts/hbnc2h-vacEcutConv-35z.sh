...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 3841 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 4082 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 4243 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 4494 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 4671 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
...
abinit_check.sh 1
abinit_check.sh 2
run_tiniba.sh -r run -k 452 -N 0 -x 2 -C 8 -P 4923 -w -e -p -s ; run_tiniba.sh -r erase ; run_tiniba.sh -r erasescf
