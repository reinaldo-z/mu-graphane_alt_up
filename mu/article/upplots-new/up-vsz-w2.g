...
set format y2 "%3.1f"
set arrow 1 from 20, 30 to 5, 30 ls 1 lw 2
set arrow 2 from second 154, 83.5 to second 175, 83.5 ls 2 lw 2
set arrow 3 from second X1, Y1 to second X1, 81.0 ls 3 lw 2.0 
set arrow 4 from second X2, Y2 to second X2, 84.8 ls 5 lw 2.0 

p   './magsv.sm_0.03_az_12802_40-1.972eV' u 3:($2*f) w l axis x1y1 lw 2  t '\Large $\mathcal{V}_{\sigma^{\mathrm{z}}}$' ,\
    './magsv.sm_0.03_az_12802_40-1.972eV' u 3:6      w l axis x1y2 lw 2  t '\Large $\gamma_{z}$' ,\
