...
set label 1 '\Large \emph{Up} @ $\alpha=35^{\circ}$' at graph 0.03 , 0.65 
...
p   'up-vx-vy-w2.data1' u 1:($5*f) axis x1y1 w l lw 2 t '\Large $\mathcal{V}^{\mathrm{x}}$' ,\
    'up-vx-vy-w2.data1' u 1:($6)   axis x1y2 w l lw 2 t '\Large $\theta_{\mathrm{x}}$' ,\
    'up-vx-vy-w2.data1' u 1:($7)   axis x1y2 w l lw 2 t '\Large $\gamma_{\mathrm{x}}$'
...
set y2range [0:375]
set y2tics 0, 45, 360
p   'up-vx-vy-w2.data2' u 1:($5*f) axis x1y1 w l lw 2 t '\Large $\mathcal{V}^{\mathrm{y}}$' ,\
    'up-vx-vy-w2.data2' u 1:($6)   axis x1y2 w l lw 2 t '\Large $\theta_{\mathrm{y}}$' ,\
    'up-vx-vy-w2.data2' u 1:($7)   axis x1y2 w l lw 2 t '\Large $\gamma_{\mathrm{y}}$'
