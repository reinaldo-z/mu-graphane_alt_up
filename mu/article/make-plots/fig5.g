...
sp  'fig5.dataup1' u 1:3:($2*f) w l lw 1.0 lt 8
...
p   'fig5.dataup2' u 3:($2*f) w l axis x1y1 lw 2  t '\Large $\mathcal{V}_{\sigma^{\mathrm{z}}}$' ,\
    'fig5.dataup2' u 3:6      w l axis x1y2 lw 2  t '\Large $\gamma_{\sigma^z}$' ,\
