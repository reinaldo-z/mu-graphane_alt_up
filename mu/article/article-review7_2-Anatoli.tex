...
relaxation time in conventional semiconducting materials is too short to enable the
...
of interest and their band structure. % Do you think that the band structure 
...
higher compared to 3D bulk materials. Considering the fact that the spin relaxation time in pure and
doped graphene ranges from nanoseconds to milliseconds,
\cite{wojtaszekPRB13,ertlerPRB09}, and in view of the
high spin velocity transport that we obtained for the both
structures, this time is sufficiently long enough to have the SVI effect observed experimentally. Therefore, the Up and the Alt graphene structures
