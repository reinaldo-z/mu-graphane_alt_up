...
% \node[anchor=south west,inner sep=0] at (0.2,0.0)  
% {\includegraphics[width=\textwidth]{up1}};
% \draw [line width=2.00mm, red, -> ] (8.50,8.00) -- (18.50,13.50) node [right] {};
% \draw [line width=2.00mm, red, -> ] (8.50,8.00) -- (18.50,02.00) node [right] {};
% \draw [line width=2.00mm, red, dashed ] (18.50,13.50) -- (28.50,8.00) node [right] {};
% \draw [line width=2.00mm, red, dashed ] (18.50,02.00) -- (28.50,8.00) node [right] {};
% \node[anchor=south west,inner sep=0] at (0.2,-20.0) 
% {\includegraphics[width=\textwidth]{up2}};
% \node[anchor=south west,inner sep=0] at (0.2,-34.0) 
% {\includegraphics[width=0.30\textwidth]{arrows2}};
