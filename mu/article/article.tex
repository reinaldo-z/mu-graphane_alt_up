...
\affiliation{Centro de Investigaciones en \'Optica, Le\'on, Guanajuato 37150,
M\'exico}
\author{Bernardo S. Mendoza}
\affiliation{Centro de Investigaciones en \'Optica, Le\'on, Guanajuato 37150,
M\'exico}
\author{Anatoli I. Shkrebtii}
\affiliation{University of Ontario, Institute of Technology, Oshawa, ON, L1H
7L7, Canada}
...
%large enough that spin-split states can become quasidegenerate.
To include the coherences, we follow Ref.~\onlinecite{nastosPRB05} and use a
...
% The maxima for $\hbar\omega=0.084$ eV and $\alpha=35^{\circ}$, with
...
of magnitude as those of Ref.~\onlinecite{najmaiePRB03} in unbiased
