...
\hline
\end{tabular}
\caption{\color{red} Comparison of the reported maxima values of $\mathcal{V}^{\mathrm{ab}}$
...
and $|\mathcal{V}^{\mathrm{y}}|$. In Fig. \ref{fig:up-3d-vva-1} we present the
...
1.80\,eV to 2.10\,eV presented in Fig. \ref{fig:up-3d-vva-2} where two local maxima
...
\ref{fig:alt-3d-vva} we present the $|\mathcal{V}^{\mathrm{a}}|$ spectra resulting 
