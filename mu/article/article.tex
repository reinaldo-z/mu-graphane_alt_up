...
those angles.
% 
From Fig. \ref{fig:up-vaz-rag-1} we have that the maximum response is obtained
for an incoming beam with energy of 0.088\,eV and polarization angle
...
and $\mathcal{V}^{\mathrm{yz}}(\omega)=87.2$\,Km/s and being this response the
absolute maximum of the spin velocity polarized in the $\mathrm{z}$ direction
for the \emph{up} structure and corresponding a velocity angle
...
$\gamma_{\mathrm{x}}(\omega)$ are collinear at $65.5^{\circ}$ and being almost
constant in the complete range corresponding to a response
$|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=82.3$\,Km/s indicated with the
green arrow; also the blue square box indicates the value for which the
polarization angle and the response angle are perpendicular corresponding to
$\alpha=155.5^{\circ}$ and corresponding to a response
$|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=30.5$\,Km/s indicated with the blue
arrow.
% 
Now from Fig. \ref{fig:up-vaz-rag-2} we have that a local maxima of the response
is obtained for an incoming beam with energy of 0.912\,eV and same polarization
angle $\alpha=40^{\circ}$ resulting in a value of
$|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=30.3$\,Km/s and corresponding a
velocity angle $\gamma_{\mathrm{z}}(\omega)=78^{\circ}$ on the $xy$ plane. Again
the green circled box indicates the value for which the polarization angle
$\alpha$ and the response direction angle $\gamma_{\mathrm{z}}(\omega)$ are
collinear corresponding to $78^{\circ}$ and having variations of $\pm 2^{\circ}$
for $0^{\circ} \leq \alpha \leq 122^{\circ}$; this value corresponds to a response $|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=23.5$\,Km/s indicated with the green arrow. The blue square box indicates the value for which the polarization angle and the response angle are perpendicular corresponding to 
% 
% WRONG
% $\alpha=78.5^{\circ}$ and being held for  and corresponding to a response $|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=10.3$\,Km/s indicated with the blue arrow.
...
\begin{figure}[t]
    \centering
    \subfigure[\ $|\mathcal{V}^{\mathrm{x}}|(\omega)$ for \emph{up} structure
    \label{fig:up-3d-vvx-1}]
    {\includegraphics[width=\linewidth]{upplots/up-3d-vxb-1}}
    \\
    \subfigure[\ $|\mathcal{V}^{\mathrm{y}}|(\omega)$ for \emph{up} structure
...
% %%        vab-rtp.sm_0.03_x_14452_65-spin_scissor_0_Nc_32_ang_145
% %%        vab-rtp.sm_0.03_y_14452_65-spin_scissor_0_Nc_32_ang_145
