...
\begin{figure}[tb]
    ...
    \\
    \subfigure[\ $|\mathcal{V}^{\mathrm{x}}|$ \label{fig:alt-vy-comp-rtp}]
...
same intensity giving a total spin-velocity near to 30\,Km/s and spin angles
$\theta$ and $\varphi$ near to $45.8^{\circ}$ and $40.7^{\circ}$, respectively.
%
...
resulting in a spin-velocity magnitude near to 20\,Km/s. In this case the spin
angle over the $xy$ plane have values near to $290^{\circ}$ and the
corresponding polar angle correspond to values near to $153^{\circ}$.
%
...
% %%%%%%%%%%%%%%%%
Making now the analysis for $|\mathcal{V}^{\mathrm{y}}|$, we notice that this
response is almost two times more intense than $|\mathcal{V}^{\mathrm{x}}|$. For
the energy range from 0.70\,eV to 0.74\,eV the $yz$ component have a more
intense response than $yx$ and $yy$ components. This results in a spin azimuthal
angle near to $221^{\circ}$ and polar angle near to $141^{\circ}$.
%
For the energy range all three components have
almost the same intensity resulting in a spin-velocity near to 50\,Km/s in both
cases.
%
