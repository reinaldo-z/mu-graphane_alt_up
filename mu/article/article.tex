...
% \begin{figure}[t]
%     \centering
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{x}}}|$ for \emph{up} structure 
%     \label{fig:up-3d-vsx-1}]
%     {\includegraphics[width=\linewidth]{upplots/up-3d-svax-1}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$ for \emph{up} structure 
%     \label{fig:up-3d-vsy-1}]
%     {\includegraphics[width=\linewidth]{upplots/up-3d-svay-1}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{z}}}|$ for \emph{up} structure 
%     \label{fig:up-3d-vsz-1}]
%     {\includegraphics[width=\linewidth]{upplots/up-3d-svaz-1}}
    
%     \caption{\color{red} $|\mathcal{V}_{\sigma^{\mathrm{x}}}|$,
%     $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$, and
%     $|\mathcal{V}_{\sigma^{\mathrm{z}}}|$ responses for the \emph{up}
%     structure.}
%     \label{fig:up-3d-vsb-1}
% \end{figure}
...
%     \centering
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{x}}}|$ for \emph{up} structure 
%     \label{fig:up-3d-vsx-2}]
%     {\includegraphics[width=\linewidth]{upplots/up-3d-svax-2}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$ for \emph{up} structure 
%     \label{fig:up-3d-vsy-2}]
%     {\includegraphics[width=\linewidth]{upplots/up-3d-svay-2}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$ for \emph{up} structure 
...
%     \caption{\color{red} $|\mathcal{V}_{\sigma^{\mathrm{z}}}|$ response for the
%     \emph{up} structure.}
...
% \begin{figure}[t]
%     \centering
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{x}}}|$ for \emph{alt} structure 
%     \label{fig:alt-3d-vsx}]
%     {\includegraphics[width=\linewidth]{altplots/alt-3d-svax}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$ for \emph{alt} structure 
%     \label{fig:alt-3d-vsy}]
%     {\includegraphics[width=\linewidth]{altplots/alt-3d-svay}}
%     \\
%     \subfigure[\ $|\mathcal{V}_{\sigma^{\mathrm{z}}}|$ for \emph{alt} structure 
%     \label{fig:alt-3d-vsz}]
%     {\includegraphics[width=\linewidth]{altplots/alt-3d-svaz}}


%     \caption{\color{red} $|\mathcal{V}_{\sigma^{\mathrm{x}}}|$,
%     $|\mathcal{V}_{\sigma^{\mathrm{y}}}|$, and
%     $|\mathcal{V}_{\sigma^{\mathrm{z}}}|$ responses for \emph{alt} structure. }
...
\begin{figure}[t]
    ...
    range from 0.07\,eV to 0.10\,eV and for polarization angles from
    $25^{\circ}$ to $50^{\circ}$.}
...
$|\mathcal{V}^{\mathrm{a}}|(\omega)$ spectra resulting from evaluate Eq.
