...
\begin{figure}[t]
    ...
    for an energy range from 0.08\,eV to 0.10\,eV, in the Far Infrared, and the
    local maximum from 1.95\,eV to 2.0\,eV, in the visible, both for
    polarization angles between $25^{\circ}$ and $50^{\circ}$.}
    \label{fig:up-3d-vsz}   
\end{figure}
