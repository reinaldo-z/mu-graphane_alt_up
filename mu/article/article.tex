...
% section theory-pure_spin_current (end)
...
\begin{figure}[t]
    ...
    $\mathcal{V}^{\mathrm{ab}}$ for \emph{alt}, \emph{up}, CdSe, and GaAs structures}
...
% section res-pure_spin_current_and_spin_velocity (end)
...
% section res-layer_by_layer_analysis (end)
