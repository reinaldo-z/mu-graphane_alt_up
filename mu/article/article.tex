...
% %%%%%%%%%%%%%%%%
% %% 0.0 eV - 0.16 eV
% %% Starting description of UP |V^{a}|, components and RTP
% %% files: magv.sm_0.03_xb_14452_65-spin_scissor_0_Nc_32_incang_0-180-step5
% %%        alt-plots/alt-3d-vab.gp
% %%%%%%%%%%%%%%%%
From this picture we can see that for the zone between the energy range of
...
polarization angle is $\alpha=40^{\circ}$ and the energy of the incoming beam is 0.088\,eV. 
%
\ref{fig:up-vx-comp-rtp-1} and \ref{fig:up-vy-comp-rtp-1} we present the results
for $|\mathcal{V}^{\mathrm{x}}|$ and $|\mathcal{V}^{\mathrm{y}}|$ fixing the
polarization angle to $40^{\circ}$ for the \emph{up} structure vs photon energy
and the corresponding polar $\varphi$ and azimuthal $\theta$ angles. In the
bottom frames of Figs. \ref{fig:up-vx-comp-rtp-1} and \ref{fig:up-vx-comp-rtp-1}
we present the decomposition of $|\mathcal{V}^{\mathrm{x}}|$ and
$|\mathcal{V}^{\mathrm{y}}|$ in the corresponding $\mathcal{V}^{\mathrm{xx}}$,
...
angles of $\varphi=47.4$ and $\theta=212.5$, respectively. Also we found that. Now, from Fig.
\ref{fig:up-vy-comp-rtp-1} we have that for the same incoming beam energy the
$yx$ and $yy$ components have less contributions for the total response than the
$yz$ having values of $\mathcal{V}^{\mathrm{yx}}= -7.9$\,Km/s
$\mathcal{V}^{\mathrm{yy}}=  8.5$\,Km/s $\mathcal{V}^{\mathrm{yz}}= 87.1$\,Km/s
and resulting in a value of the total response of
$|\mathcal{V}^{\mathrm{y}}|=87.9$\,Km/s with polar and azimuthal angles
$\varphi=7.6$ $\theta=132.6$, respectively.
\begin{figure}[t]
    \centering
    \subfigure[\ $|\mathcal{V}^{\mathrm{x}}|$ for \emph{up} structure 
...
\end{figure}
Also there is another zone of interest, depicted in Fig. \ref{fig:up-3d-2},
where a local maximum is obtained for energies from 0.95\,eV to 0.99\,eV and
same polarization angles. From Figs. \ref{fig:up-3d-vx-2} ad 
\ref{fig:up-3d-vy-2} we have that $|\mathcal{V}^{\mathrm{x}}|$ and $|\mathcal{V}
^{\mathrm{y}}|$ reach values of 10\,Km/s and 50\,Km/s, respectively.
% %%%%%%%%%%%%%%%%
% %% Starting description of UP |V^{a}|, components and RTP
% %% files: magv.sm_0.03_xb_14452_65-spin_scissor_0_Nc_32_incang_0-180-step5
% %%        alt-plots/alt-3d-vab.gp
