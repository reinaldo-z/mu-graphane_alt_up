...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/altstruc1}\hspace{0.05\textwidth}
    \includegraphics[width=0.45\textwidth]{figures/altstruc2}
    \caption{Alt structure.}
    \label{fig:altstruc}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/upstruc1}\hspace{0.05\textwidth}
    \includegraphics[width=0.45\textwidth]{figures/upstruc2}
    \caption{Up structure}
    \label{fig:upstruc}
\end{figure}
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.45\textwidth]{figures/hnbGh-aa-1}\hspace{0.05\textwidth}
%     \includegraphics[width=0.45\textwidth]{figures/hnbGh-aa-2}
%     \caption{HNBC$_{2}$H-aa structure}
%     \label{fig:aastruc}
% \end{figure}
% \begin{figure}[h]
%     \centering
%     \includegraphics[width=0.45\textwidth]{figures/hnbGh-ab-1}\hspace{0.05\textwidth}
%     \includegraphics[width=0.45\textwidth]{figures/hnbGh-ab-2}
...
&= \frac{\mu^{\mathrm{abxx}}(\omega)E^{2}(\omega)\cos^{2}\theta + 
\mu^{\mathrm{abyy}}(\omega)E^{2}(\omega)\sin^{2}\theta + 
2\mu^{\mathrm{abxy}}(\omega)E^{2}(\omega)\cos\theta\sin\theta }
{\xi^{\mathrm{xx}}(\omega)E^{2}(\omega)\cos^{2}\theta + \xi^{\mathrm{yy}}(\omega)E^{2}(\omega)\sin^{2}\theta},
\nonumber \\
&= \frac{\mu^{\mathrm{abxx}}(\omega)\cos^{2}\theta + 
\mu^{\mathrm{abyy}}(\omega)\sin^{2}\theta + 2\mu^{\mathrm{abxy}}(\omega)\cos\theta\sin\theta }
{\xi^{\mathrm{xx}}(\omega)\cos^{2}\theta + \xi^{\mathrm{yy}}(\omega)\sin^{2}\theta}.
\label{eq:vab}
\end{align}
...
top hydrogen atoms and the second by the carbon atoms. The layer divisions and atom positions for the unit cells are shown in Tables \ref{tab:altunitcell} and 
\ref{tab:upunitcell}.

\begin{table}[tb]
\caption{Unit cell of \emph{alt} structure.}
\center
\begin{tabular}{ccccc}\label{tab:altunitcell}  \\
\hline
...
Layer division, atom types and positions for the \emph{alt} structure.
The structure unit cell was divided in six layers corresponding each one to
atoms in different $z$ positions.
\end{minipage}
\end{table}

\begin{table}[tb]
\caption{Unit cell of \emph{up} structure.}
\center
\begin{tabular}{ccccc}\label{tab:upunitcell}  \\
\hline
Layer & Atom & \multicolumn{3}{c}{Position [\AA]} \\
\cline{3-5}
No. & type & $x$ & $y$ & $z$  \\
...
\end{tabular} \\
\begin{minipage}{0.42\textwidth}
Layer division, atom types and positions for the \emph{up} structure.
The structure unit cell was divided in two layers corresponding to
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% xb [0.6:1.0] %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$\mathcal{V}^{\mathrm{xb}}$}
\begin{figure}[ht!]
    \centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% yb [0.6:1.0] %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{$\mathcal{V}^{\mathrm{yb}}$}
\begin{figure}[ht]
    \centering
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{altplots/alt-absvab.pdf}
...
\subsubsection{$\mathcal{V}^{\mathrm{xb}}$ energy range 0.0--0.2 eV }
\begin{figure}[h]
    \centering
...
\subsubsection{$\mathcal{V}^{\mathrm{yb}}$ energy range 0.0--0.2 eV }
\begin{figure}[h]
    \centering
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{upplots/up-absvab-1.pdf}
    \caption{Comparisson of $|\mathcal{V}^{\mathrm{xb}}|$ and $|\mathcal{V}^{\mathrm{yb}}|$}    
...
\subsubsection{$\mathcal{V}^{\mathrm{xb}}$ energy range 1.8--2.1 eV }
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.7\textwidth]{upplots/up-absvab-2.pdf}
    % \caption{Comparisson of $|\mathcal{V}^{\mathrm{xb}}|$ and $|\mathcal{V}^{\mathrm{yb}}|$}    
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.7\textwidth]{aaplots/hnbGh-aa-absvab.pdf}
%     \caption{Comparisson of $|\mathcal{V}^{\mathrm{xb}}|$ and $|\mathcal{V}^{\mathrm{yb}}|$.}    
...
% \begin{figure}[ht!]
%     \centering
%     \includegraphics[width=0.7\textwidth]{abplots/hnbGh-ab-vxb.pdf}
%     \caption{Three components of $\mathcal{V}^{\mathrm{xb}} $ @ 155$^{\circ}$.}
%     \label{fig:ab-vxb}
% \end{figure}
...
% \begin{figure}[ht]
%     \centering
%     \includegraphics[width=0.7\textwidth]{abplots/hnbGh-absvab.pdf}
%     \caption{Comparisson of $|\mathcal{V}^{\mathrm{xb}}|$ and $|\mathcal{V}^{\mathrm{yb}}|$.}    
