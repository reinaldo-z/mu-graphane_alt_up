...
Secondly, we choose the SVI direction along
...
the Alt. These speed values are larger than those of bulk semiconductors,
...
In this paper, we present two 50\% hydrogenated graphene
...
we address theoretically the SVI 
...
atoms according to Table \ref{tab:up-unitcell} are not equivalent, or are they?}} 
    \label{fig:up-struc}
\end{figure}
\begin{figure}[ht!]
    \centering
...
\label{eq:dotk}
\end{equation}
where repeated Cartesians upperscripts  are summed, and 
...
coordinates by the defined  polar angle
\begin{equation}
...
\hline
H$_1$ & -0.61516 & -1.77416 &  0.73196 \\
H$_2$ &  0.61518 &  0.35514 &  0.73175 \\
C$_1$ & -0.61516 & -1.77264 & -0.49138 \\
C$_2$ & -0.61516 & -0.35600 & -0.72316 \\
C$_3$ &  0.61516 &  0.35763 & -0.49087 \\
C$_4$ &  0.61518 &  1.77416 & -0.73196 \\
\hline
\end{tabular}
\caption{
...
\quad type \qquad & $x$ & $y$ & $z$  \\
\hline
H$_1$ &  -0.61516 &  -1.42140 & \ 1.47237 \\
C$_1$ &  -0.61516 &  -1.73300 & \ 0.39631 \\
C$_2$ & \ 0.61516 & \ 1.73300 & \ 0.15807 \\
C$_3$ & \ 0.61516 & \ 0.42201 &  -0.15814 \\
C$_4$ &  -0.61516 &  -0.37396 &  -0.39632 \\
H$_2$ &  -0.61516 &  -0.68566 &  -1.47237 \\
\hline
\end{tabular}
\caption{
...
\caption{$\mathcal{V}^{\mathrm{ab}}(\omega,\alpha)$ 
  {\it vs.} $\hbar\omega$, for the angles $\alpha$ that maximize the signal. The
...
Eq.~\eqref{eq:mu}, 
${\cal V}^{\mathrm{a}\mathrm{b}}(\omega,\alpha)$ becomes different 
...
\caption{
For the Up structure we show the velocity $\mathcal{V}_{\mathrm{a}}
...
\caption{For 
the Up structure we show the spin velocity $\mathcal{V}_{\mathrm{a}}
(\omega,\alpha)$ (left scale, black line), the polar angle $\theta_{\mathrm{a}}
(\omega,\alpha)$ (right scale, red line), and the azimuthal angle
$\varphi_{\mathrm{a}} (\omega,\alpha)$, (right scale, blue line), {\it vs.}
$\hbar\omega$, for $\alpha=35^\circ$, and $\mathrm{a}=x$ or $\mathrm{a}=y$. 
}
...
\caption{For the Alt structure we show  the velocity $\mathcal{V}_{\mathrm{a}}
(\omega,\alpha)$ (left scale, black line), the polar angle $\theta_{\mathrm{a}}
(\omega,\alpha)$ (right scale, red line), and the azimuthal angle
$\varphi_{\mathrm{a}} (\omega,\alpha)$, (right scale, blue line), {\it vs.}
$\hbar\omega$, for $\alpha=150^\circ$, and $\mathrm{a}=x$ or $\mathrm{a}=y$.
}
...
(\omega,\alpha)$ (right scale, red line), and the azimuthal angle
$\varphi_{\mathrm{a}} (\omega,\alpha)$, (right scale, blue line), {\it vs.}
$\hbar\omega$, for $\alpha=150^\circ$, and $\mathrm{a}=x$ or
$\mathrm{a}=y$.
}
