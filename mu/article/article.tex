...
for an incoming beam with energy of 0.088\,eV and polarization angle of
$40^{\circ}$ resulting in a value of 37.4\,Km/s coming from the contribution of
the components $\mathcal{V}^{\mathrm{xz}}(\omega)=39.8$\,Km/s and
$\mathcal{V}^{\mathrm{yz}}(\omega)=87.2$\,Km/s and being this response the
...
% 
In the same figure the green circled box indicates the angle 
% cicled green box; deviation?

% From the same figure we have that for a polarization angle $\alpha=65^{\circ}$
% the response is directed in the same angle direction being collinear and
% resulting in a value of
% $|\mathcal{V}_{\sigma^{\mathrm{z}}}|(\omega)=82.3$\,Km/s;
